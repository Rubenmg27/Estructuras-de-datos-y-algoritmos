...
#ifndef CONTACTO_H    
#define CONTACTO_H  //evitar compilar compila varias veces contactos con esto solo lo hará una vez
...
*/
string nombre(const contacto& c); //no se puede modificar c, usar para datos voluminosos
